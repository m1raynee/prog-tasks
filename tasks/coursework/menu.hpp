// 7.31. ѕроводитс€ учет выполнени€ работ разного вида несколькими исполнител€ми. 
// “ребуетс€ хранить информацию об исполнител€х (‘»ќ, адрес, табельный номер),
// о работах (наименование, исполнители, норма на исполнител€/-ей, тариф)
// и о выполненных работах (исполнители, наименование, объем, дата завершени€).
// Ќадо обеспечить возможность получени€:
//     - общего списка работ и их исполнителей,
//     - списка выполненных работ на конкретную дату/период (группировка по исполнител€м и/или видам работ),
