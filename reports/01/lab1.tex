...
\begin{xltabular}
    ...
    \lstinputlisting{../../tasks/1.1/out.txt} & \lstinputlisting{../../tasks/1.2/out.txt} \\ \hline
    \lstinputlisting{../../tasks/1.1/out copy.txt} & \lstinputlisting{../../tasks/1.2/out copy.txt} \\ \hline
\end{xltabular}
